...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name != null ? variables.name : "Aquí Tu Nombre"} ${
    variables.lastName != null ? variables.lastName : "Y apellido"
  }
          </h1>
          <h2>${variables.role != null ? variables.role : "Función"}</h2>
